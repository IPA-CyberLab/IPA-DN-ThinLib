...
L_PROXY_RETRY_WITH_ALTERNATIVE_FQDN:
	...
	Format(ver_str, sizeof(ver_str), "Ver=%u,Build=%u,Release=%s,CommitId=%s,Suite=%s", CEDAR_VER, CEDAR_BUILD, THINLIB_VER_LABEL, THINLIB_COMMIT_ID, DESK_PRODUCT_NAME_SUITE);
